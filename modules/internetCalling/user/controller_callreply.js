...
controllers.controller('CallReplyController',function($state,$scope,$rootScope,CallLogService,GlobalModule_dataStoreService,$stateParams,GlobalModule_notificationService,$websocket,TicketService){
