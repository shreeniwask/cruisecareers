...
services.service('Userwalkin_Service',['$rootScope','$location','$http', function($rootScope, $location, $http) {
...
this.fetchWalkinJobListForUserforlandingpage = function(search,userId,walkinflag){
...
this.fetchWalkinImageListForLandingPage = function(walkinflag){
...
this.fetchDateAndTimeSlots = function(jobfairId,selectedDate){
	...
	this.deleteUserSlot = function(userId){
		var promise = $http({
			method : 'POST',
			data:userId,
	...
	this.getActiveWalkinCount = function(walkinflag){
		var promise = $http({
			method : 'GET',
			url : 'rest/userjobfair/getactivewalkincount/'+walkinflag,
			headers : {
				'Content-Type' : 'application/json'
			},
			cache : false
